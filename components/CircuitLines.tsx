    ...
    <>
      ...
      >
        <svg className="h-full w-full" viewBox="0 0 180 900" fill="none" preserveAspectRatio="none">
          ...
          <path d="M60 0 L60 180 L120 220 L120 380 L75 410 L75 520 L105 540 L105 650 L60 680 L60 900" stroke="rgba(0,0,0,0.06)" strokeWidth="2" fill="none" />
          <path d="M105 0 L105 120 L45 160 L45 340 L90 370 L90 480 L50 510 L50 620 L80 640 L80 900" stroke="rgba(0,0,0,0.05)" strokeWidth="2" fill="none" />
          <path d="M30 0 L30 250 L80 280 L80 450 L35 480 L35 600 L75 630 L75 750 L45 780 L45 900" stroke="rgba(0,0,0,0.04)" strokeWidth="1.5" fill="none" />
          ...
          <circle cx="60" cy="180" r="4" fill="#0066CC" opacity="0.4" />
          <circle cx="120" cy="220" r="3.5" fill="#0066CC" opacity="0.35" />
          <circle cx="75" cy="410" r="4" fill="#0066CC" opacity="0.4" />
          <circle cx="105" cy="540" r="3.5" fill="#0066CC" opacity="0.35" />
          <circle cx="60" cy="680" r="4" fill="#0066CC" opacity="0.4" />
          <circle cx="45" cy="160" r="3.5" fill="#0066CC" opacity="0.3" />
          <circle cx="90" cy="370" r="4" fill="#0066CC" opacity="0.35" />
          <circle cx="50" cy="510" r="3.5" fill="#0066CC" opacity="0.3" />
          <circle cx="80" cy="640" r="4" fill="#0066CC" opacity="0.35" />
          <circle cx="80" cy="280" r="3.5" fill="#0066CC" opacity="0.3" />
          <circle cx="35" cy="480" r="3.5" fill="#0066CC" opacity="0.3" />
          <circle cx="75" cy="630" r="4" fill="#0066CC" opacity="0.35" />

          {/* Horizontal branch ticks — thicker */}
          <line x1="60" y1="180" x2="90" y2="180" stroke="rgba(0,0,0,0.05)" strokeWidth="2" />
          <line x1="75" y1="410" x2="110" y2="410" stroke="rgba(0,0,0,0.05)" strokeWidth="2" />
          <line x1="105" y1="540" x2="140" y2="540" stroke="rgba(0,0,0,0.04)" strokeWidth="1.5" />
          <line x1="45" y1="340" x2="15" y2="340" stroke="rgba(0,0,0,0.04)" strokeWidth="1.5" />
          <line x1="35" y1="480" x2="8" y2="480" stroke="rgba(0,0,0,0.04)" strokeWidth="1.5" />
          <line x1="80" y1="280" x2="120" y2="280" stroke="rgba(0,0,0,0.04)" strokeWidth="1.5" />

          {/* Square nodes — bigger */}
          <rect x="86" y="175" width="7" height="7" rx="1.5" fill="#0066CC" opacity="0.3" />
          <rect x="106" y="405" width="7" height="7" rx="1.5" fill="#0066CC" opacity="0.3" />
          <rect x="136" y="535" width="7" height="7" rx="1.5" fill="#0066CC" opacity="0.25" />
          <rect x="116" y="275" width="7" height="7" rx="1.5" fill="#0066CC" opacity="0.25" />
        </svg>
      </div>
