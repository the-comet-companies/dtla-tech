...
export function Iphone({
  ...
  return (
    ...
    >
      ...
      {!hasVideo && src && (
        <div
          className="pointer-events-none absolute z-0 overflow-hidden flex flex-col"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
        ...
        >
          {/* Spacer for the notch / dynamic island area */}
          <div className="shrink-0" style={{ height: "5.8%" }} />
          <img
            src={src}
            alt=""
      ...
      >
        ...
        <path
          ...
          className="fill-[#E5E5E5] stroke-[#E5E5E5] stroke-[0.5]"
